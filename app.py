...
def format_data(data, fields=None):
    ...
    if fields is None:
        fields = ["Property Name", "Price", "Beds", "Baths", "Sqft", "Home Type",  "URL of Property", "Combined List of Amenities and List of Features"]
    ...
    system_message = f"""You are an intelligent text extraction and conversion assistant. Your task is to extract structured information 
                        ...
                        with no additional commentary, explanations, or extraneous information. strictly provide list in square brackets.
...
if __name__ == "__main__":
    ...
    # url = 'https://www.luxhabitat.ae/villas-for-sale/dubai/'
    #url = 'https://www.seloger.com/immobilier/achat/immo-lyon-69/'
    data = pd.read_excel('output/sorted_data_1.xlsx')
    # data['Listing URL']
    dfs= []
    j=0
    output_csv_path = 'merged_data0.csv'
    # listing_url
    # Listing URL
    for i in data['Listing URL']:
      url = i
      j+=1
        # try:
      try:   # Generate timestamp
...
#         file_path = 'output/rawData_20240606_064555.md'
