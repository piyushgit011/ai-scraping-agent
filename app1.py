...
def format_data(data, fields=None):
    ...
    if fields is None:
        fields = ["Address", "Property Name", "Listing URL"]
...
def save_formatted_data(formatted_data, timestamp, output_folder='output'):
    ...
    excel_output_path = os.path.join(output_folder, f'sorted_data_1.xlsx')
...
if __name__ == "__main__":
    ...
    url = 'https://www.propertyfinder.ae/en/buy/dubai/villas-for-sale.html?page=1'
